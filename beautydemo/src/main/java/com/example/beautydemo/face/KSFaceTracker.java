...
import com.example.beautydemo.face.utils.ConUtil;
import com.example.beautydemo.face.utils.FaceppConstraints;
import com.example.beautydemo.face.utils.SensorEventUtil;
 ...
 * 人脸检测器
 */
public final class KSFaceTracker implements IFaceTracker{
    ...
    private static class FaceTrackerHolder {
        private static KSFaceTracker instance = new KSFaceTracker();
    }

    private KSFaceTracker() {
        mFaceTrackParam = FaceTrackParam.getInstance();
    }

    public static KSFaceTracker getInstance() {
     ...
     * @return
     */
    public KSFaceTracker enable3DPose(boolean enable) {
     ...
     * @return
     */
    public KSFaceTracker enableROIDetect(boolean enable) {
     ...
     * @return
     */
    public KSFaceTracker enable106Points(boolean enable) {
     ...
     * @return
     */
    public KSFaceTracker enableMultiFace(boolean enable) {
     ...
     * @return
     */
    public KSFaceTracker enableFaceProperty(boolean enable) {
     ...
     * @return
     */
    public KSFaceTracker minFaceSize(int size) {
     ...
     * @return
     */
    public KSFaceTracker detectInterval(int interval) {
     ...
     * @return
     */
    public KSFaceTracker trackMode(int mode) {
     ...
     * Face++SDK联网请求验证
     */
    private static void requestFaceNetwork(Context context) {
        ...
        licenseManager.takeLicenseFromNetwork(uuid, FaceppConstraints.API_KEY, FaceppConstraints.API_SECRET, apiName,
                ...
                new LicenseManager.TakeLicenseCallback() {
                    ...
                    public void onFailed(int i, byte[] bytes) {
                        if (VERBOSE) {
                            Log.e(TAG, "Failed to register license!");
                        }
